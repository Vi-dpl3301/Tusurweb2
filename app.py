...
app.config['RECAPTCHA_PUBLIC_KEY'] = '6Lceq8QrAAAAAAJku7gjFiyDL2u39cOZ6hYJco9-'
app.config['RECAPTCHA_PRIVATE_KEY'] = '6Lceq8QrAAAAAAYnAm-1V6cCiFffkg4FDf_Nw89c'
...
class ImageForm(FlaskForm):
    ...
    border_size = IntegerField('Размер рамки (% от ширины)', validators=[InputRequired()])
